...
final Formation formation433 = Formation(
  ...
  slots: const [
    ...
    FormationSlot(code: 'LB', label: 'Sol Bek', acceptedDetailedPositions: _lbPos, fallbackBroadPosition: 'Defender', x: 0.15, y: 0.25),
    ...
    FormationSlot(code: 'RB', label: 'Sağ Bek', acceptedDetailedPositions: _rbPos, fallbackBroadPosition: 'Defender', x: 0.85, y: 0.25),
    ...
    FormationSlot(code: 'LW', label: 'Sol Kanat', acceptedDetailedPositions: _lwPos, fallbackBroadPosition: 'Attack', x: 0.15, y: 0.78),
    FormationSlot(code: 'ST', label: 'Forvet', acceptedDetailedPositions: _stPos, fallbackBroadPosition: 'Attack', x: 0.5, y: 0.85),
    FormationSlot(code: 'RW', label: 'Sağ Kanat', acceptedDetailedPositions: _rwPos, fallbackBroadPosition: 'Attack', x: 0.85, y: 0.78),
  ],
  adjacency: const [
...
final Formation formation442 = Formation(
  ...
  slots: const [
    ...
    FormationSlot(code: 'CB', label: 'Stoper', acceptedDetailedPositions: _cbPos, fallbackBroadPosition: 'Defender', x: 0.62, y: 0.20),
    FormationSlot(code: 'RB', label: 'Sağ Bek', acceptedDetailedPositions: _rbPos, fallbackBroadPosition: 'Defender', x: 0.85, y: 0.25),
    FormationSlot(code: 'LM', label: 'Sol Orta Saha', acceptedDetailedPositions: _lmPos, fallbackBroadPosition: 'Midfield', x: 0.12, y: 0.55),
    ...
    FormationSlot(code: 'RM', label: 'Sağ Orta Saha', acceptedDetailedPositions: _rmPos, fallbackBroadPosition: 'Midfield', x: 0.88, y: 0.55),
...
final Formation formation352 = Formation(
  ...
  slots: const [
    ...
    FormationSlot(code: 'LWB', label: 'Sol Kanat Bek', acceptedDetailedPositions: _lbPos, fallbackBroadPosition: 'Defender', x: 0.08, y: 0.45),
    FormationSlot(code: 'RWB', label: 'Sağ Kanat Bek', acceptedDetailedPositions: _rbPos, fallbackBroadPosition: 'Defender', x: 0.92, y: 0.45),
...
List<Formation> allFormations = [formation433, formation442, formation352];