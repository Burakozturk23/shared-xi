  ...
  Widget _accountBody() {
    ...
    if (user == null) {
      return const Text(
        ...
        'Günün maçları veya Online gibi oturum gerektiren bir özelliği '
        'kullandığında anonim Firebase hesabı oluşturulur.',
      );
    }
  ...
  Widget _inlineDeleteConfirmation() {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
          color: AppTheme.dangerColor.withValues(alpha: 0.55),
        ),
